...
//! Stores are a primitive for creating deeply-nested reactive state, based on [`halyard_reactive_graph`].
//!
...
//!     traits::{Read, Write},
//! };
//! use halyard_reactive_stores::{Patch, Store};
//!
...
//! ```rust
//! pub mod foo {
//!   use halyard_reactive_stores::Store;
...
//! pub mod user {
//!   use halyard::prelude::*;
//!   use halyard_reactive_stores::Field;
...
//! use halyard_reactive_stores::{OptionStoreExt, Store};
//! use halyard_reactive_graph::traits::{Get, Read};
//!
//! #[derive(Store)]
...
//! use halyard_reactive_stores::StoreFieldIter;
//! use halyard_reactive_stores::StoreFieldIterator;
...
//! ```rust
//! use halyard_reactive_stores::Store;
//! use halyard_reactive_graph::traits::{Read, Get};
//!
//! #[derive(Store)]
//! enum Choices {
//!    First,
...
//! use halyard_reactive_stores::{Store, DerefField, OptionStoreExt};
//! use halyard_reactive_graph::traits::{ Read, Get };
//!
//! #[derive(Store)]
//! struct List {
...
//! ```rust
//! # use halyard_reactive_stores::{Store, Patch};
//! #[derive(Debug, Store, Patch, Default)]
//! struct Name {
//!     first: String,
//!     last: String,
...
pub use halyard_reactive_stores_macro::{Patch, Store};
...
/// [`RwSignal`](halyard_reactive_graph::signal::RwSignal).
...
mod tests {
    use crate::{
        self as halyard_reactive_stores, Patch, Store, StoreFieldIterator,
    };
    use halyard_reactive_graph::{
        effect::Effect,
        owner::StoredValue,

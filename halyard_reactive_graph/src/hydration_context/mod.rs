...
//!
//! This module helps with the second part of this process. It provides a [`SharedContext`]
//! type that allows you to store data on the server, and then extract the same data in the
//! client. The browser's side (`HydrateSharedContext`) needs the `browser` feature.
...
#[cfg(feature = "browser")]
mod hydrate;
// compiled for the native tests too

...
fn test_local_custom_executor() {
    ...
    impl halyard_reactive_graph::executor::CustomExecutor for LocalTestExecutor {
        fn spawn(
            &self,
            fut: halyard_reactive_graph::executor::PinnedFuture<()>,
        ) {
        ...
        fn spawn_local(
            &self,
            fut: halyard_reactive_graph::executor::PinnedLocalFuture<()>,
        ) {

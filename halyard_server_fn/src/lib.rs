...
//! ### `#[server]`
//!
//! The [`#[server]`](../halyard/attr.server.html) macro allows you to annotate a function to
...
//!
//! [server]: ../halyard/attr.server.html
...
/// use halyard_server_fn::{Http, ServerFnError, codec::{Json, GetUrl}};
///
...
/// # use halyard_server_fn_macro_default::server;
/// # #[cfg(feature = "browser")] {
/// use halyard_server_fn::{ServerFnError, BoxedStream, Websocket, codec::JsonEncoding};
/// use serde::{Serialize, Deserialize};
///
...
/// use halyard_server_fn::{BoxedStream, ServerFnError};
///

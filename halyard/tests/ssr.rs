...
fn test_multiple_class_attributes_overwrite() {
    ...
    let el = halyard::html::div().class("first").class("second");
...
// or static text node.)
//
// This scenario has already been fixed with a new approach on the `halyard_0.9` branch. Leaving this

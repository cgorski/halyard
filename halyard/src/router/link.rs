use crate::router::{components::RouterContext, hooks::use_resolved_path};
use halyard::{children::Children, oco::Oco, prelude::*};
use halyard_reactive_graph::{computed::ArcMemo, owner::use_context};
...
///
/// ```rust
/// # use halyard::prelude::*; use halyard::router::components::A;

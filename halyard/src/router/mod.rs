//! # The router
//!
//! `halyard::router` is a router and state management tool for web applications
//! written in Rust using the Halyard web framework.
...
//! ## Philosophy
//!
//! The router is built on a few simple principles:
...
//!
//! 3. **Progressive enhancement.** The [`A`](crate::router::components::A) and
//!    [`Form`](crate::router::components::Form) components resolve any relative
...
//! ```rust
//! use halyard::prelude::*;
//! use halyard::router::components::*;
//! use halyard::router::path;
//! use halyard::router::hooks::use_params_map;
//!
//! #[component]
...
//!
//! Its server side (rendering routes to HTML, reading the request's URL) is compiled with
//! `halyard`'s `ssr` feature.
//!
...
#[doc(inline)]
pub use halyard_macro::{lazy_route, path};
pub use matching::*;
pub use method::*;
pub use navigate::*;
pub use ssr_mode::*;
...
pub(crate) mod view_transition {
    use crate::router::error::{js_reason, report, RouterError};
    use halyard::dom::helpers::document;

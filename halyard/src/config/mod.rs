...
/// What can go wrong reading the configuration.
pub mod errors;

use crate::config::errors::HalyardConfigError;
...
#[non_exhaustive]
pub struct ConfFile {
    /// The options read from the file and the environment.
...
impl HalyardOptions {
    ...
    ///
    /// ```
    /// use halyard::config::HalyardOptions;
    ///
...
/// The short name of the development environment (`HALYARD_ENV=dev`).
pub const ENV_DEV_KEY_SHORT: &str = "dev";
/// The long name of the development environment (`HALYARD_ENV=development`).
pub const ENV_DEV_KEY_LONG: &str = "development";
/// The short name of the production environment (`HALYARD_ENV=prod`).
pub const ENV_PROD_KEY_SHORT: &str = "prod";
/// The long name of the production environment (`HALYARD_ENV=production`).

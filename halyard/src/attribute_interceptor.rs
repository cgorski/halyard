...
///
/// By default, Halyard passes any attributes passed to your component (e.g. `<MyComponent
...
/// ```
/// # use halyard::prelude::*;
/// use halyard::attribute_interceptor::AttributeInterceptor;
///
/// #[component]
    ...
    for AttributeInterceptorInner<T, A>
{
    ...
    fn to_html_with_buf(
        self,
        buf: &mut String,
        position: &mut halyard::tachys::view::Position,
        escape: bool,
        mark_branches: bool,
    ...
    fn hydrate<const FROM_SERVER: bool>(
        self,
        cursor: &halyard::tachys::hydration::Cursor,
        position: &halyard::tachys::view::PositionState,
    ) -> Self::State {

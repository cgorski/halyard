...
//! # Halyard Meta
//!
//! Halyard Meta allows you to modify content in a document’s `<head>` from within components
//! using the [`Halyard`](https://github.com/leptos-rs/leptos) web framework.
//!
    ...
    Ch: RenderHtml + Send,
{
    ...
    fn to_html_with_buf(
        ...
        if let Some(cx) = use_context::<ServerMetaContext>() {
            ...
            let msg = "tried to use a halyard_meta component without \

...
//! ## Philosophy
//!
//! Halyard Router is built on a few simple principles:
...
//! ```rust
//! use halyard::prelude::*;
//! use halyard_router::components::*;
//! use halyard_router::path;
//! use halyard_router::hooks::use_params_map;
//!
//! #[component]
...
#[doc(inline)]
pub use halyard_router_macro::{lazy_route, path};
pub use matching::*;
pub use method::*;
pub use navigate::*;
pub use ssr_mode::*;

...
impl SharedContext for CsrSharedContext {
    ...
    ) -> Vec<(halyard_throw_error::ErrorId, halyard_throw_error::Error)> {
        Vec::new()
    }
    ...
    fn take_errors(
        ...
        SerializedDataId,
        halyard_throw_error::ErrorId,
        halyard_throw_error::Error,
    )> {
        Vec::new()
    }
    ...
    fn register_error(
        ...
        _error_id: halyard_throw_error::ErrorId,
        _error: halyard_throw_error::Error,
    ) {
    }

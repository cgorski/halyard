...
// use halyard::*;
// use halyard_actix::generate_route_list;
// use halyard_router::{
...
//
//     // We still have access to the original (albeit normalized) Halyard paths:
//     assert_same(
//         &routes,
//         |r| r.halyard_path(),
...
//     );
//
//     // ... But halyard-actix has also reformatted "paths" to work for Actix.
//     assert_same(
//         &routes,
//         |r| r.path(),
...
//
//     // In Exact mode, the Halyard paths no longer have their trailing slashes stripped:
//     assert_same(
//         &routes,
//         |r| r.halyard_path(),
//         &["/bar/", "/baz/*any", "/baz/:id", "/baz/:name/", "/foo"],

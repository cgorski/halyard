...
mod router {
    ...
    use halyard_axum::{ErrorHandler, HalyardRoutes, generate_route_list};
            ...
            match cli.mode {
                ...
                Mode::FallbackWithContext => Router::new()
                    ...
                    .fallback(halyard_axum::file_and_error_handler_with_context(
                        move || {
                            let opts =
                                use_context::<halyard_axum::ResponseOptions>()
                                    .unwrap_or_default();
                            opts.insert_header(
                ...
                Mode::ErrorHandlerServiceFallback => Router::new()
                    ...
                    .fallback_service(
                        halyard_axum::site_pkg_dir_service(&halyard_options)
                ...
                Mode::RouteSitePkgNoFallback => Router::new()
                    ...
                    .route_service(
                        &halyard_axum::site_pkg_dir_service_route_path(
                            &halyard_options,
                        ),
                        halyard_axum::site_pkg_dir_service(&halyard_options),
                    )

...
/// # use axum::Router;
/// # use halyard::prelude::*;
/// # use halyard_axum::{HalyardRoutes, generate_route_list};
/// # #[component]
...
///     // .fallback(halyard_axum::file_and_error_handler(shell))
///     .fallback_service(
///         halyard_axum::site_pkg_dir_service(&halyard_options).fallback(
///             halyard_axum::ErrorHandler::new(shell, halyard_options),
///         ),
///     );
/// ```
#[derive(Clone, Debug)]

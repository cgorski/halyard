...
/// The app's view in these tests: a text node. (An element built with `view!` needs
/// `halyard/ssr` to render to HTML, which this crate's own test build does not enable.)

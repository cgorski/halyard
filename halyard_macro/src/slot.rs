...
impl ToTokens for Model {
    fn to_tokens(&self, tokens: &mut TokenStream) {
        ...
        let output = quote! {
            ...
            #docs
            #prop_docs
            #[derive(::halyard::typed_builder_macro::TypedBuilder)]
            #[builder(doc, crate_module_path=::halyard::typed_builder)]
            ...
            /*impl #impl_generics ::halyard::Props for #name #generics #where_clause {
            ...
            impl #impl_generics ::halyard::DynAttrs for #name #generics #where_clause {
